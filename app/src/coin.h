...
#define MAINNET_TRANSPARENT_HRP "tnam"
#define TESTNET_TRANSPARENT_HRP "testtnam"
typedef enum {
  key_ed25519 = 0,
  key_secp256k1 = 1,
} signing_key_type_e;
...
typedef enum {
  addr_mainnet_transparent = 0,
  addr_testnet_transparent = 1,
  addr_masp_transparent_secp256k1 = 2,
  addr_masp_shielded = 3,  // was addr_sapling
  addr_masp_shielded_div = 4,
} address_kind_e;
