...
// Specific APDU error codes for MASP
...
#define APDU_CODE_PREV_OUT_INVALID           0x6992
#define APDU_CODE_SEQUENCE_INVALID          0x6993
#define APDU_CODE_OUTPUTS_INVALID           0x6994
#define APDU_CODE_JOIN_SPLIT_INVALID         0x6995
...
#define APDU_CODE_BAD_VALUE_BALANCE          0x69A1
